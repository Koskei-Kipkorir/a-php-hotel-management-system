...
<section class="about-section bg-light p-5" >
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 mt-4">
                    ...
                    <p class="title-para ml-5">The ACE Hotel is a jewel
                    ...
                    <p class="title-para ml-5">The ACE Hotel is not merely the building but, above all, its people.
  ...
  <div class="container">
    <div class="row align-items-center mb-2">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">We offer the best meeting and events forums and meeting rooms</p><a href="client/eventBooking.php" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">For the best vacation experiences</p><a href="client/roomBooking.php" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    <div class="profile"> <img src="assets/picture/Founder1.jpg"> </div></small> </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Jack mendez<br /> <small>Space CEO</small> </div>
                    <div class="card-subtitle">
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Kevin Koskey<br /> <small>Resident dj at the lounge</small> </div>
                    <div class="card-subtitle">
