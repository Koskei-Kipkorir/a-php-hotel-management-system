...
<!-- Carousel  -->
       ...
       <div class="carousel-inner">
         <div class="carousel-item active">
           ...
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5">A wholesome experience</h1>
         ...
         <div class="carousel-item ">
           ...
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5 text-dark">Well connected to roads and a transport system </h1>
               <p class="text-dark">Ease accesibility to commercial area and affordable parking</p>
             </div>
         </div>
         <div class="carousel-item ">
 ...
 <section class="py-5 white-section" id="introduction" >
   <div class="container">
     <h1 class="display-4 title">   THE ACE HOTEL </h1>
     <p class="lead">With well connected roads for the safety of our clients</p>
   </div>
   ...
   <div class="container"> 
           ...
           <p class="text-justify">This ornate, palatial tribute to Northern Kenya  greatest empires -The pasific - overlooks 
               verdant foliage in the heart of Nairobi. This luxury hotel offers one of the largest banqueting 
               facilities in Kenya, 10 award winning F&B outlets, signature wellness experiences and more.<br>
               ...
               <br>
               The ace hotel has 522 rooms and 78 luxuriously appointed service apartments- collectively 
                   its 600 spacious guest rooms, suites and luxury service apartments,are the epitome 
                   of Kenyan grace and style, expertly delegated with thoughtful amenities.The pasific meets 
               ...
               <p><blockquote class="blockquote">Ideal Location</blockquote>
                       ...
                       and luxury. Built in the midst of the business hub of Guindy and located in the heart of Nairobi
                        is within close proximity to many key areas of the city and is just 8
      ...
      <div class="col-md-3" style="float:left">
       <div class="card mb-2 ">
          ...
          <div class="card-body">
            ...
            <a class="btn btn-primary">Suite</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <a class="btn btn-primary">Break</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Capture a lifetime of great memories.
               Includes Wi-Fi, Breakfast and more</p>
            <a class="btn btn-primary">Wellness</a>
          </div>
        </div>
      </div>
       ...
       <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> Apartments which
                        are the epitome of Kenyan  grace and style</p>
            <a class="btn btn-primary">Accomodation</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <a class="btn btn-primary">Gateway</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Ten distinct dining destinations featuring Kenyan & international 
              cuisine along with well appreciated and prized beverages</p>
            <a class="btn btn-primary">Conference</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Dream up a wedding and turn it into
               an event extraordinaire. Encapsulate the memorable moments into reality</p>
            <a class="btn btn-primary">Wedding</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3" style="float:left">
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">The  meeting rooms are the perfect combination
               of space and audio visual equipments
            </p>
            <a class="btn btn-primary">Meeting</a>
          </div>
        </div>
      </div>
	...
	<div class="row">
		...
		<div class="message"></div>
			<div class="contact-form">
				<h1>Contact Us</h1>
				<p class="hint-text">We are here for you! Contact us for any queries.</p>
